...
SemanticAnalyzer.prototype.rules = {
  ...
  'multiplication expression': function(semantics) {
    var type1 = this.children[0].meta.type
    var type2 = this.children[2].meta.type
    
    semantics.checkIfNumeric(this.children[0], 'multiplication')
    semantics.checkIfNumeric(this.children[2], 'multiplication')
